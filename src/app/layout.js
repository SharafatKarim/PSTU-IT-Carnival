...
export const metadata = {
  ...
  openGraph: {
    ...
    description: "South Zone's largest tech competition. Twelve events across programming, hackathon, data, quiz, security and gaming. IUPC final registration is open — pay the entry fee by 6 August 2026, 11:59 PM.",
    type: "website",
    images: [
      {
        url: '/cover.jpg',
